...
public interface MovieCRUDMapper {
	...
	//영화 제목으로 영화 조회하기
	public ArrayList<MovieVO> getListByTitle(String movieTitle);
	
	//개봉일로 영화 조회하기
	public ArrayList<MovieVO> getListByreleaseDate(String start, String end);
	
	//제목 + 개봉일로 영화 조회하기
	public ArrayList<MovieVO> getListByTitleDate(String movieTitle, String start, String end);
